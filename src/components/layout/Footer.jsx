...
// Logos Generales
import icaiLogo from "../../assets/logos/icai-logo.svg"; // Ojo, usa el nombre exacto que tengas
    ...
    <footer className="footer">
      <div className="footer__container">
        ...
        <div className="footer__left">
          ...
          <p className="footer__tagline">ICAI Formula Student Team</p>
          ...
          <div className="footer__socials">
            ...
            {/* CAMBIO: Ahora lleva al canal principal */}
        ...
        <div className="footer__right">
          ...
          <a href="mailto:formulastudent@iscracingteam.com" className="footer__contact-link">
            Contact Us
          </a>
        </div>
