...
export default function MotoSponsors() {
  ...
  return (
    <div className="moto-sponsors-page">
      ...
      <section className="sponsors-intro">
        <div className="intro-content">
          ...
          <p className="intro-text">
            El proyecto <strong>ISC MS Racing Team</strong> es una realidad gracias al apoyo de empresas líderes que apuestan por el talento joven y la innovación sobre dos ruedas.
            <br /><br />
            Su colaboración técnica y económica nos permite diseñar, fabricar y competir con nuestro prototipo eléctrico en MotorLand Aragón.
            <br />
            <strong>¡Gracias por acompañarnos en cada curva!</strong>
          </p>
          
          {/* BOTÓN EN LA CABECERA APUNTANDO A SPONSOR US DE MOTO */}
          <Link to="/moto/sponsor-us" className="sponsor-btn-top">
            PATROCÍNANOS
          </Link>
        </div>
      </section>
      ...
      <section className="join-sponsors-cta">
        ...
        <p>Únete a nuestro equipo e impulsa la innovación eléctrica.</p>
        <Link to="/moto/sponsor-us" className="sponsor-cta-btn">
          PATROCÍNANOS
        </Link>
      </section>
