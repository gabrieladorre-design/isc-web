    ...
    <div className="ms-page">
      ...
      <section className="ms-stats">
        <div className="container stats-grid">
          <AnimatedCounter end={7} label="EDITIONS" />
          <AnimatedCounter end={80} label="UNIVERSITIES" />
          <AnimatedCounter end={20} label="COUNTRIES" />
        </div>
      </section>

      {/* 5. VIDEO FINAL - Promo Oficial MotoStudent (Puedes cambiar la ID luego) */}
