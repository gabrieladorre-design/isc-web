...
/* --- OJO: SUBIMOS 4 NIVELES PARA LLEGAR A ASSETS --- */
...
export default function Team() {
  ...
  return (
    <div className="moto-team-page">
      
      {/* CABECERA */}
      <header className="team-header">
        <h1>Nuestro Equipo</h1>
        <p>Impulsados por la innovación, unidos por la velocidad en dos ruedas.</p>
      </header>

      {/* ESTADÍSTICAS Y DESCRIPCIÓN ADAPTADAS A MOTOSTUDENT */}
