import "./MotoContact.scss";

// ICONOS REDES (Subimos 4 niveles)
...
// IMPORTA TUS DOSSIER (Cambia el nombre del archivo cuando tengas los de la moto)
...
export default function MotoContact() {
  ...
  return (
    <div className="moto-contact-page">
      
      {/* CABECERA */}
      <header className="contact-header">
        <h1>Contacta con Nosotros</h1>
        <p>¿Tienes alguna duda o propuesta para MotoStudent? Estamos aquí para escucharte.</p>
      </header>
        ...
        <div className="info-column">
          ...
          <div className="contact-card highlight-border">
            ...
            <div className="contact-item">
              ...
              <a href="mailto:motostudent@iscracingteam.com" className="main-email">
                ✉️ motostudent@iscracingteam.com
              </a>
            </div>
          </div>
          ...
          <div className="contact-card highlight-card">
            ...
            <p>Descarga nuestro dossier oficial con toda la información técnica del prototipo y opciones de colaboración.</p>
            
            <div className="dossier-buttons">
              <a href={dossierPdfES} download="Dossier_ISC_MotoStudent_ES.pdf" className="download-btn">
                VERSIÓN ESPAÑOL
              </a>
              <a href={dossierPdfEN} download="Dossier_ISC_MotoStudent_EN.pdf" className="download-btn">
                ENGLISH VERSION
              </a>
            </div>
          </div>
      ...
      {/* SECCIÓN FAQ ADAPTADA A MOTOSTUDENT */}
      <section className="faq-section">
        <h2>Preguntas Frecuentes</h2>
        <div className="faq-grid">
          <div className="faq-item">
            <h4>¿Cómo puedo unirme al equipo?</h4>
            <p>El proceso de selección suele abrirse en septiembre y enero. Visita la sección <a href="/moto/recruitment">Recruitment</a> para ver si el plazo está abierto.</p>
          </div>
          <div className="faq-item">
            <h4>¿Buscáis patrocinadores?</h4>
            <p>¡Siempre! Si representas a una empresa interesada en apoyar la innovación eléctrica en dos ruedas, descarga nuestro <strong>Dossier</strong> o llámanos.</p>
          </div>
          <div className="faq-item">
            <h4>¿Organizan visitas?</h4>
            <p>Sí, organizamos jornadas de puertas abiertas puntuales en nuestro taller. Anunciamos las fechas en nuestro Instagram.</p>
          </div>
        </div>
      </section>
